...
class SlackRenderer(Renderer):
    ...
    async def on_tool_call(
        ...
        # Display-form redaction lives here so both dashboard and native callers inherit it.
        title = self.redact_for_target(title)
        tool_purpose = self.redact_for_target(tool_purpose)
